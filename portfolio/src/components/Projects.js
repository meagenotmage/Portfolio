  ...
  const projects = [
    {
      ...
      category: 'web',
      status: 'completed',
      features: ['Responsive Design', 'Smooth Animations', 'Contact Form', 'Modern UI/UX'],
      liveDemo: '#',
      github: '#'
    },
    {
      ...
      category: 'desktop',
      status: 'completed',
      features: ['User Authentication', 'CRUD Operations', 'Database Integration', 'Reports Generation'],
      github: '#'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      image: <FaBicycle />,
      technologies: ['JavaScript', 'GPS API', 'Charts.js'],
      category: 'web',
      status: 'planning',
